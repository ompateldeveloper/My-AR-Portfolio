...
document.addEventListener("DOMContentLoaded", () => {
  const start = async () => {
    ...
    const portfolioItem0Video = await loadVideo(
      "../assets/portfolio/portfolio/preview.mp4"
    );
    ...
    const avatar = await loadGLTF(
      "../assets/models/business_card_background/scene.gltf"
    );
        ...
        if (o.userData.clickable) {
          if (o === webIcon) {
            ...
            textElement.innerHTML =
              "Greetings! I go by the name Nikhil Garg, and I'm a pleasant software developer.";
          }
        }
      }
    });
